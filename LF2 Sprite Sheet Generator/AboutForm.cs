...
namespace LF2.Sprite_Sheet_Generator
{
	internal sealed partial class AboutForm : Form
	{
		...
		public AboutForm()
		{
			...
			this.assemblyVersionLabel.Text = String.Format("Assembly Version {0}", AssemblyVersion);
			this.productVersionLabel.Text = String.Format("Product Version {0}", Application.ProductVersion);
			this.copyrightLabel.Text = AssemblyCopyright;
			this.companyNameLabel.Text = "By " + AssemblyCompany;
